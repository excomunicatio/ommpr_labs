...
3. **Особенность решения:** В данном варианте обе задачи дали одинаковое оптимальное решение (вершина 3). Это означает, что вершина 3 является одновременно и центром графа (для минимаксной задачи), и медианой графа (для минисуммной задачи).
